...
const sunilSingh = () => {
  ...
  useEffect(() => {
    ...
    setMainHeight(bodyHeight - navHeight);
  }, []);
    ...
    >
      <div className="h-100">
        <div className="container-fluid d-flex px-0 h-100 justify-content-between row align-items-center">
          ...
          <div
            className="h-100 product-details col-md-6"
          ...
          >
            <motion.div variants={stagger} className="inner">
              ...
              >
                ...
                learning, robotics, blockchain and others. He is one of the
                early proponents of blockchain-enabled technology.
              </motion.article>
              <motion.article
                variants={fadeInUp}
                className="py-2 def-line-height"
              ...
              >
                <p>
                  He is based in Dubai and engaged in diverse business verticals
                  that encompass
                </p>
              </motion.article>
