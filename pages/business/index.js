        ...
        <motion.div className="row">
          <motion.article className="col-md-12">
            <motion.article variants={fadeInUp} className="def-line-height">
              Mojay Global Holding Limited is a diversified organisation having
              its presence across the areas of Technology &amp; Robotics,
              Mobility, FMCG, Real Estate and Financial Assets. <br /> We work
              collaboratively with our key stakeholders of the companies to take
              the businesses to the next level of profitable growth.
            </motion.article>
          </motion.article>
        </motion.div>
                ...
                <motion.div className="col-md-7 p-5 order-2 order-lg-1">
                  ...
                  <motion.div variants={fadeInUp}>
                    <motion.p className="def-line-height">
                      ...
                      Starting its operations in 2018, in Dubai, the company is
                      currently one of the leading providers of chauffeured car
                      rental services. Within a short span of time, MLLIMO
                      scaled up and extended its client base, demonstrating
                      steady growth of sales. It made more than 1,500 Trips per
                      month by the end of 2019 and over 17,000 Trips until
                      pandemic COVID-19 hit the world.
                    </motion.p>
                  </motion.div>
                  <motion.div variants={fadeInUp}>
                    <a className="default_link_1" href="https://www.preimo.com">
                      www.preimo.com
                    </a>
                  </motion.div>
                </motion.div>
                ...
                <motion.div className="col-md-7 p-5">
                  ...
                  <motion.div animate={inView ? fadeInUp.animate : ""}>
                    <motion.p className="def-line-height">
                      ...
                      2019. The focus of the company is to develop new products
                      by using technology that makes human execution easy and
                      efficient. From construction to agriculture, logistics,
                      energy, and infrastructure, the prospects for product
